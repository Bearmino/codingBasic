...
a = "I eat %d apples." % 3
print(a)
# 문자열에 숫자를 넣고 싶은 자리에 %d를 넣어주고, 문장 가장 뒤에 삽입할 숫자를 % 뒤에 넣음
# %d는 정수형 포맷 코드라고 부른다.
...
print(a)
# f 문자열 포매팅에서도 name,age와 같은 변수 값을 생성 후 참조가능, f 문자열 포매팅은 표현식을 지원한다.
...
#문자열 관련 함수들
#문자열 자료형은 기본적으로 함수를 가지고 있다.(내장함수) 이 내장 함수를
#사용하려면 문자열 변수 뒤에 '.'을 붙인 다음 함수 이름을 써주면된다.
